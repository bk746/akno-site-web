...
export function SiteHeader() {
  ...
  useEffect(() => {
    ...
    let raf = 0;
    let lastScrolled = header.classList.contains("site-header--scrolled");
    let lastLight = header.classList.contains("site-header--light");

    const update = () => {
      raf = 0;
      const scrolled = window.scrollY > SCROLL_GLASS_THRESHOLD;
      const onLight = isLightSurfaceAtHeader();
